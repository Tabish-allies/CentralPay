...
class FlipkartProductDetailPage extends StatefulWidget {
  final VoidCallback showCardCallback; // Callback function

  const FlipkartProductDetailPage({Key? key, required this.showCardCallback})
      : super(key: key);

  @override
  State<FlipkartProductDetailPage> createState() =>
      _FlipkartProductDetailPageState();
}

class _FlipkartProductDetailPageState extends State<FlipkartProductDetailPage> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 15),
                      const Text(
                        "You can paste the Flipkart product Link here",
                        style: TextStyle(
                      ...
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          hintText: "Paste the Flipkart link here",
